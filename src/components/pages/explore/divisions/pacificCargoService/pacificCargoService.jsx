        ...
        <Fragment>
            ...
            <div className="pcs_detail_main">
                 ...
                 <div className="left_bar_img_garllay" style={{marginLeft: "-60px", marginTop: "36%"}}>
                        <img src={pcsImage01} alt="pcs_side_image_one"  width="95%"  /> 
                        <img src={pcsImage02} alt="pcs_side_imgae_two"  width="95%"/>
                        <img src={pcsImage03} alt="pcs_side_imgae_three" width="95%"/> 
                        <img src={pcsImage04} alt="pcs_side_imgae_three" width="95%" /> 
                    </div>
